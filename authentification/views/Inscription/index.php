...
<head>
	...
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="/authentification/views/Inscription/inscriptionStyle.css">
</head>
<body>
	<div class="loginField">
		<img src="/authentification/views/Inscription/logoUniv.jpeg" class="univLogo">
		<form action="/authentification/Inscription/inscrire" method="post">
			<legend>
